...
function WindTurbine({ windSpeed = 0 }) {
  ...
  return (
    <div className="relative flex w-full items-center justify-center py-2" style={{ minHeight: '280px' }}>
      <style>{`
      ...
      {/* SVG Turbine - enlarged viewport to prevent blade clipping during rotation */}
      ...
      {/* Ambient glow effect around turbine */}
      <div
